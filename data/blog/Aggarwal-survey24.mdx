...
Channels can be coming from the same platform (e.g., Google, Facebook) or different platforms. Here, one can study either bidding problems or auction design problems. This is an interesting setting. **I want to work on one such problem.**